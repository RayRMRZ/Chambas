       ...
       home: Scaffold(
        ...
        slivers: [
          ...
          SliverList(
            ...
            const Divider(),
              (User().logged) ? _SocialMedia(freeprovider.onlyFreelancer.freelancer)
              : Text('Inicia sesión para acceder a la información de este prestador de servicios',textAlign: TextAlign.center, style: GoogleFonts.roboto(
                              color: Colores.rojo, fontWeight: FontWeight.w400)),
        ...
        floatingActionButton: Tooltip(
          message: 'Commentarios',
          child: FloatingActionButton(
            backgroundColor: Colores.rojo,
            child: const FaIcon(FontAwesomeIcons.comment), 
            onPressed: (){
              Navigator.of(context).pushNamed(WritePost.route, arguments: {'free' : freeprovider.onlyFreelancer.freelancer});
            },),
        ),
         ),
     );
  ...
  Widget build(BuildContext context) {
    ...
    flexibleSpace:FlexibleSpaceBar(
      ...
      customSize: const Size.square(1000),
       backgroundDecoration: const BoxDecoration(color: Colores.crema),
